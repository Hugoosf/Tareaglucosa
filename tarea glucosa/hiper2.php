...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT glu, fecha, idcomida FROM hiper WHERE idusuario = ? AND MONTH(fecha) = ?";
    ...
    echo "<canvas id='graficoCircular' width='150' height='150' style='max-width: 150px; max-height: 150px;'></canvas>";  
    ...
    ?>
        ...
        <h2>Consulta de GLU por Mes (Hiperglucemia)</h2>
